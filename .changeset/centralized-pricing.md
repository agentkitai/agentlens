---
"@agentkit/pricing": minor
"@agentlensai/core": minor
"@agentlensai/server": minor
---

Centralize LLM model pricing in a new `@agentkit/pricing` package, sourced from LiteLLM's published prices with an embedded fallback.
