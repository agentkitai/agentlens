...
const Evaluators = React.lazy(() => import('./pages/eval/evaluators').then(m => ({ default: m.Evaluators })));
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAuth><Layout /></RequireAuth>}>
        ...
        <Route path="agents/insights" element={<Suspense fallback={<PageSkeleton />}><AgentInsights /></Suspense>} />
        ...
        <Route path="playground" element={<Suspense fallback={<PageSkeleton />}><Playground /></Suspense>} />
