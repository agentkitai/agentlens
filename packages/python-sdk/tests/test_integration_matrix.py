...
def _make_mock_module(name: str, classes: dict[str, dict[str, Any]], functions: dict[str, Any] | None = None):
...
def _setup_provider_mocks():
    ...
    if "openai" in sys.modules:
        ...
        if resources and hasattr(resources, "chat"):
            ...
            if chat_mod and hasattr(chat_mod, "completions"):
                compl_mod = sys.modules.get("openai.resources.chat.completions")
    ...
    if ollama_mod is None:
        ...
        ollama_mod = _make_mock_module("ollama", {
