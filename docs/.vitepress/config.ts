    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Recall API', link: '/reference/recall' },
          { text: 'Lessons API', link: '/reference/lessons' },
          { text: 'Reflect API', link: '/reference/reflect' },
          { text: 'Context API', link: '/reference/context' },
